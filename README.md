...
> 下面展示的是当前项目整理过程中的实际截图。  
> 如果后续补充到更标准、更完整的项目效果图，这一部分还会继续更新。

### 效果图 1：项目整理过程中的 Claude 中文界面截图

![效果图1](docs/images/effect-real-fullscreen.png)

### 效果图 2：占位说明

当前仓库原先误放入了与项目无关的图片，现已移除错误展示。  
后续建议补充以下真实效果图：

- 中文化后的 Claude / Codex 主界面
- `/` Slash 技能列表中文显示
- tooltip / 悬停说明中文显示

### 效果图 3：为什么暂时不继续放旧图

之前放入的几张图和这个仓库项目不对应，会误导使用者，所以我已经把错误内容从 README 主展示区撤掉。
